...
const (
	StockService_GetStock_FullMethodName      = "/inventory.v1.StockService/GetStock"
	StockService_BatchGetStock_FullMethodName = "/inventory.v1.StockService/BatchGetStock"
)
